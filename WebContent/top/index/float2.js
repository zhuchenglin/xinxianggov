...
function chinazads2(arg_isflash,arg_pic,arg_alt,arg_url,arg_flashurl,arg_Wimg,arg_Himg,arg_index)
{
	...
	Himg=arg_Himg;
	var index = arg_index;
	var pfhtml='<div id="chinazads'+index+'"  style="height:49px;left:178px;position:absolute;top:1237px;width:70px; z-index:99999">';
	pfhtml+="<div align='right' style='position:absolute;top:0px;right:0px;margin:0px;padding:0px;'><a href='#' onclick=\"$('#chinazads"+index+"').hide();return false;\" style='color:#000000;text-decoration:none;font-size:12px;'>close</a></div>";
